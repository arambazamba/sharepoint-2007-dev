...
:LInitialize
    ...
    set Install=
    set Uninstall=
    set PackageFile=%~dp0TelephoneBook.wsp
    set PackageName=TelephoneBook.wsp
...
:LValidate
    ...
    if exist "%SPFeaturesLocation%\TelephoneBook" (
       echo Error: Feature folder TelephoneBook already exists in current SharePoint.
...
:LDeploy
    ...
    echo Activating feature TelephoneBook ...
    "%SPAdminTool%" -o activatefeature -id 34715396-cdf6-48a6-85e4-4ffa33ab977a -url %TargetSiteUrl%
...
@rem----------------------------------------------------------------------
:LRetract
    echo Deactivating feature TelephoneBook ...
    "%SPAdminTool%" -o deactivatefeature -id 34715396-cdf6-48a6-85e4-4ffa33ab977a -url %TargetSiteUrl% -force

    echo Uninstalling feature TelephoneBook ...
    "%SPAdminTool%" -o uninstallfeature -id 34715396-cdf6-48a6-85e4-4ffa33ab977a -force
