...
:LInitialize
    ...
    set Install=
    set Uninstall=
    set PackageFile=%~dp0AjaxPart.wsp
    set PackageName=AjaxPart.wsp
...
:LValidate
    ...
    if exist "%SPFeaturesLocation%\AjaxPart" (
       echo Error: Feature folder AjaxPart already exists in current SharePoint.
...
:LDeploy
    ...
    echo Activating feature AjaxPart ...
    "%SPAdminTool%" -o activatefeature -id fd985187-26a6-453b-842c-9fe2ccd612c5 -url %TargetSiteUrl%
...
@rem----------------------------------------------------------------------
:LRetract
    echo Deactivating feature AjaxPart ...
    "%SPAdminTool%" -o deactivatefeature -id fd985187-26a6-453b-842c-9fe2ccd612c5 -url %TargetSiteUrl% -force

    echo Uninstalling feature AjaxPart ...
    "%SPAdminTool%" -o uninstallfeature -id fd985187-26a6-453b-842c-9fe2ccd612c5 -force
