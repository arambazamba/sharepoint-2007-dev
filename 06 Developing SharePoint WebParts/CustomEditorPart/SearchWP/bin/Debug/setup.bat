...
:LInitialize
    ...
    set Install=
    set Uninstall=
    set PackageFile=%~dp0SearchWP.wsp
    set PackageName=SearchWP.wsp
...
:LValidate
    ...
    if exist "%SPFeaturesLocation%\SearchWP" (
       echo Error: Feature folder SearchWP already exists in current SharePoint.
...
:LDeploy
    ...
    echo Activating feature SearchWP ...
    "%SPAdminTool%" -o activatefeature -id 468307eb-5e97-4a57-84ab-0c221b658a2a -url %TargetSiteUrl%
...
@rem----------------------------------------------------------------------
:LRetract
    echo Deactivating feature SearchWP ...
    "%SPAdminTool%" -o deactivatefeature -id 468307eb-5e97-4a57-84ab-0c221b658a2a -url %TargetSiteUrl% -force

    echo Uninstalling feature SearchWP ...
    "%SPAdminTool%" -o uninstallfeature -id 468307eb-5e97-4a57-84ab-0c221b658a2a -force
