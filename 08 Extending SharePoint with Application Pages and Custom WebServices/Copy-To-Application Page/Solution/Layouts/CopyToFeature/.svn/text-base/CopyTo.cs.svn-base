...
{
    public class CopyTo : LayoutsPageBase
    {
        //define the controls you are using in your code with exactly the name used in the aspx
        protected TreeView tvSite;
        protected TextBox txtSiteCol;
        protected Label lblListItem;
