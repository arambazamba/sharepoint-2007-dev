...
namespace MyCustomTheme
{
  public class FeatureThemesJob : SPJobDefinition
  {
    ...
    public FeatureThemesJob()
      : base()
    { }

    public FeatureThemesJob(SPService service, Guid featureID, bool delete)
    ...
    private static void MergeFeatureThemes(SPFeatureDefinition def, bool delete)
    {
      ...
      {
        FeatureThemesJob itj = new FeatureThemesJob(svc, def.Id, delete);
        itj.SubmitJobNow();
      }
    }
